...
module.exports = dzin = async (dzin, m, chatUpdate, store) => {
  try {
    ...
    switch (command) { 
      ...
      case "halogaes": {
        await sleep(5000)
         await dzin.sendMessage("6285143231522@s.whatsapp.net", { text: "Hai Dian! Gimana nih, rencana liburan semester kita?", ai: true }) 
         await sleep(25000)
         await dzin.sendMessage("6285143231522@s.whatsapp.net", { text: "Wah, keren! Aku lebih suka wisata pegunungan. Mau ke Puncak aja, kayaknya asik.", ai: true}) 
         await sleep(25000) 
         await dzin.sendMessage("6285143231522@s.whatsapp.net", { text: "Iya, bener banget. Udah punya rencana detailnya belum?", ai: true}) 
         await sleep(25000) 
         await dzin.sendMessage("6285143231522@s.whatsapp.net", { text: "Wah, boleh juga! Kita bisa rencana bareng nanti. Jadi, kapan kita mulai?", ai: true}) 
         await sleep(5000)
         await dzin.sendMessage("6285143231522@s.whatsapp.net", { text: "Hai Dian! Gimana nih, rencana liburan semester kita?", ai: true }) 
         await sleep(25000)
         await dzin.sendMessage("6285143231522@s.whatsapp.net", { text: "Wah, keren! Aku lebih suka wisata pegunungan. Mau ke Puncak aja, kayaknya asik.", ai: true}) 
